  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full">
        {/* Header */}
        <div className="bg-[#105588] text-white p-6 rounded-t-3xl">
          ...
          <div className="mb-6">
            <label className="block">
              <input
                ...
                className="hidden"
              />
              <div className="w-full px-4 py-3 bg-white border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-[#105588] transition-colors text-center">
        ...
        <div className="p-6 bg-gray-50 border-t border-gray-200 rounded-b-3xl">
          <div className="flex justify-end gap-4">
            ...
            <button
              ...
              className="px-6 py-3 bg-[#105588] text-white rounded-2xl hover:bg-[#0d4470] focus:outline-none focus:ring-4 focus:ring-[#105588]/30 transition-all duration-300 font-semibold flex items-center gap-2 shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            >
