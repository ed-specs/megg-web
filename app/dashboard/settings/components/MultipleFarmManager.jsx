    ...
    <div className="space-y-4">
      ...
      <div className="bg-gradient-to-r from-green-100 to-blue-100 rounded-xl p-4 border-2 border-green-300">
        <div className="flex items-start justify-between">
          <div className="flex-1">
            ...
            <p className="font-medium text-gray-800">{primaryFarmName || "Not set"}</p>
            {primaryFarmAddress && (
              <div className="flex items-start gap-1 mt-1 text-sm text-gray-600">
                <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0" />
                <p>{primaryFarmAddress}</p>
              </div>
            )}
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex items-center gap-1 px-3 py-2 bg-[#105588] text-white rounded-lg hover:bg-[#0d4470] transition-colors text-sm font-medium"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-3 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors text-sm font-medium"
                    >
                      <X className="w-4 h-4" />
                      Cancel
                    </button>
        ...
        <div className="p-4 rounded-xl border-2 border-dashed border-blue-300 bg-blue-50 space-y-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-1 px-4 py-2 bg-[#105588] text-white rounded-lg hover:bg-[#0d4470] disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-sm font-medium"
            >
            ...
            <button
              ...
              className="flex items-center gap-1 px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors text-sm font-medium"
            >
              <X className="w-4 h-4" />
              Cancel
            </button>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-3">
        <p className="text-xs text-blue-800">
          💡 <strong>Tip:</strong> Manage multiple farm locations. Click the ⬆️ icon to promote any farm to primary (used in exports). Don&apos;t forget to save changes!
        </p>
      </div>
        ...
        >
          ...
          <div className="text-center mb-6">
            <h3 className="text-lg font-semibold text-gray-800 mb-3">
              Promote &quot;{confirmPromote.farm.name}&quot; to Primary Farm?
            </h3>
            <p className="text-gray-600 leading-relaxed mb-4">
              This action will make <strong>{confirmPromote.farm.name}</strong> your primary farm.
            </p>
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-left">
              ...
              <ul className="text-sm text-blue-700 space-y-1 ml-4 list-disc">
                <li>Current primary farm <strong>&quot;{primaryFarmName || 'farm'}&quot;</strong> will be moved to additional farms</li>
                <li><strong>&quot;{confirmPromote.farm.name}&quot;</strong> will become the new primary farm</li>
                <li>This farm will be used in all exports and reports</li>
                <li>You must click &quot;Save Profile Information&quot; to persist changes</li>
              </ul>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 bg-gray-200 text-gray-700 py-3 px-6 rounded-2xl hover:bg-gray-300 transition-colors font-semibold"
            >
              Cancel
            </button>
            <button
              onClick={handleConfirmPromote}
              className="flex-1 bg-[#105588] text-white py-3 px-6 rounded-2xl hover:bg-[#0d4470] transition-colors font-semibold flex items-center justify-center gap-2"
            >
