  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden flex flex-col my-8">
        ...
        <div className="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 bg-gray-50">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-purple-100 rounded-lg">
              <GitCompare className="w-5 h-5 sm:w-6 sm:h-6 text-purple-600" />
            </div>
            <div>
              <h2 className="text-lg sm:text-xl font-semibold text-gray-800">Select Batches to Compare</h2>
        ...
        {/* Selection Info */}
        <div className="px-4 sm:px-6 py-3 bg-purple-50 border-b border-purple-200">
          ...
          {selectedBatches.length > 0 && (
            <div className="flex flex-wrap gap-2 mt-2">
              {selectedBatches.map(batchNum => (
                <span key={batchNum} className="px-2 py-1 bg-white border border-purple-300 rounded text-xs font-mono text-purple-900 flex items-center gap-1">
                  {batchNum}
                  <button
                ...
                return (
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      ...
                      {isSelected && (
                        <div className="flex-shrink-0 w-5 h-5 bg-purple-600 rounded-full flex items-center justify-center ml-2">
        ...
        <div className="p-4 sm:p-6 border-t border-gray-200 bg-gray-50">
          <div className="flex flex-col-reverse sm:flex-row gap-3">
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-medium"
            >
              <GitCompare className="w-4 h-4" />
              Compare {selectedBatches.length > 0 && `(${selectedBatches.length})`}
            </button>
          </div>
